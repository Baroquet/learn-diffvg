...
def main(args):
    ...
    img = render(w, # width
                 ...
                 None,
                 *scene_args)
    pydiffvg.imwrite(img.cpu(), 'results/finite_difference_comp/img_withpf.png', gamma=1.0)
    ...
    pydiffvg.imwrite(x_diff, 'results/finite_difference_comp/ours_x_diff_withpf.png', gamma=1.0)
